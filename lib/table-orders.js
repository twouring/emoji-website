...
function addLine(items, menu, { item_id, qty, by, guest, note: note0 }) {
  ...
  const line = {
    line: crypto.randomUUID().replace(/-/g, '').slice(0, 10), item_id: it.id, venue: it.venue, zh: it.zh, en: it.en, price: it.price, qty: n,
...
module.exports = { MenuLib, TABLE_RE, TAPPAY_API, tableKey, verifyTable, tableUrl, tappayConfig, menuIndex, addLine, removeLine, selectLines, unpaid, sum, payer, payByPrime, sessionFinished, cleanText };
