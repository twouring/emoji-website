...
async function listAssets(prefix = 'assets/', max = 1000) {
  ...
  try {
    ...
    do {
      ...
      for (const o of r.Contents || []) out.push({ key: o.Key, size: o.Size, lastModified: o.LastModified, url: `${S3_PUBLIC()}/${S3_BUCKET()}/${o.Key}` });
...
module.exports = { uploadAsset, listAssets, normalizePage, checkBanned, checkStyle, renderPostImages, publishPost, publishDue, refreshToken, getToken, bannedList, aiPhraseList };
